 ...
 */
public class ByteTextureComponent2D extends TextureComponent2D
{
    /** The image data */
    private byte[][] pixels;
    ...
    public ByteTextureComponent2D(int format,
                                  ...
                                  boolean yUp)
    {
        this(format, width, height, srcPixels);
        ...
        throws InvalidWriteTimingException
    {
        ...
        sendTextureUpdate(destX, destY, 0, width, height, 1, level, img);
    }
