               ...
               OffscreenCullable
{
    ...
    public MRTOffscreenTexture2D(GLCapabilities caps,
                                 ...
                                 int numTargets)
    {
        this(caps, false, width, height, numTargets, false);
    }
    ...
    public MRTOffscreenTexture2D(GLCapabilities caps,
                                 ...
                                 boolean separateDepthTexture)
    {
        this(caps, false, width, height, 0, numTargets, separateDepthTexture);
    }
                                 ...
                                 boolean separateDepthTexture)
    {
        ...
        if(separateDepthTexture)
        {
            ...
            data.enableFloatingPointColorBuffer(caps.getPbufferFloatingPointBuffers());
