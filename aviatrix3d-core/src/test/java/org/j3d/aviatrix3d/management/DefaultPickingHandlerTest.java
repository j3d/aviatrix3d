...
public class DefaultPickingHandlerTest
{
    ...
    public void testPointSinglePick(int sortType, int pickType) throws Exception
    {
        PickRequest test_request = new PickRequest();
...
//        assertEquals(result_path.getNode(0), mock_target, "Target not in the path");
    ...
    @Test(groups = "unit", dataProvider = "single child pick options")
    public void testRaySinglePick(int sortType, int pickType) throws Exception
    {
        PickRequest test_request = new PickRequest();
...
//        assertEquals(result_path.getNode(0), mock_target, "Target not in the path");
    ...
    @Test(groups = "unit", dataProvider = "single child pick options")
    public void testLineSegmentSinglePick(int sortType, int pickType) throws Exception
    {
        PickRequest test_request = new PickRequest();
